...
create table `stripe_bitcoin_transaction` (
  `amount` bigint NOT NULL,
  `bitcoin_amount` bigint NOT NULL,
  `created` bigint NOT NULL,
  `currency` text NOT NULL,
...
create table `stripe_credit_note_line_item` (
  `amount` bigint NOT NULL,
  `description` text,
  `discount_amount` bigint NOT NULL,
  `discount_amounts` json NOT NULL,
...
create table `stripe_alipay_account` (
  `created` bigint NOT NULL,
  `customer_id` varchar(191),
...
create table `stripe_financial_connections_account_owner` (
  `email` text,
  `id` varchar(191) primary key,
  `name` text NOT NULL,
  `object` text NOT NULL,
...
create table `stripe_recipient` (
  ...
  `cards` json,
  `created` bigint NOT NULL,
  `default_card_id` varchar(191),
  `description` text,
  `email` text,
  `id` varchar(191) primary key,
  `livemode` boolean NOT NULL,
  `metadata` json NOT NULL,
  `migrated_to_id` varchar(191),
  `name` text,
  `object` text NOT NULL,
  `rolled_back_from_id` varchar(191),
  `type` text NOT NULL
);
...
create table `stripe_setup_attempt` (
  `application_id` varchar(191),
...
create table `stripe_usage_record_summary` (
  `id` varchar(191) primary key,
  `invoice` text,
  `livemode` boolean NOT NULL,
  `object` text NOT NULL,
...
create table `stripe_terminal_configuration` (
  `id` varchar(191) primary key,
...
create table `stripe_terminal_location` (
...
create table `stripe_terminal_reader` (
  `action` json,
